...
public class TestSuite extends TestBase {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        /*2.5 Verify the Text "Build your own computer"*/
            ...
            softAssert.assertEquals(expectingText, actualText);
        ...
        softAssert1.assertEquals(expectingPrice,actualPrice);
        ...
        softAssert2.assertEquals(actualVerifyMsg,expectedVerifyMsg);
        ...
        softAssert3.assertEquals(actualShoppingCartText,expectedShoppingCartText);
        ...
        String actualPrice1 = driver.findElement(By.xpath("//form[@id='shopping-cart-form']/div[1]/table/tbody/tr/td[6]/span")).getText();
        String expectedPrice2 = "$1,425.00";
        softAssert4.assertEquals(actualPrice1,expectedPrice2);
        ...
        softAssert5.assertEquals(actualWelcomeText,expectedWelcomeText);
